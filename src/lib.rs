...
//!
//! ```rust
//! use aurora_blake2::{Blake2b512, Blake2s256, Digest};
//! use hex_literal::hex;
//!
...
//! ```rust
//! use aurora_blake2::Blake2bVar;
//! use aurora_blake2::digest::{Update, VariableOutput};
//! use hex_literal::hex;
//!
...
//! ```rust
//! use aurora_blake2::{Blake2b, Digest, digest::consts::U10};
//! use hex_literal::hex;
//!
